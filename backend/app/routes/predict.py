...
async def save_prediction(
    ...
    try:
        # Calculate ages
        father_age = calculate_age(request.father.dob)
        mother_age = calculate_age(request.mother.dob)
        ...
        prediction = Prediction(
            ...
            father_dob=datetime.combine(request.father.dob, datetime.min.time()),
            ...
            mother_dob=datetime.combine(request.mother.dob, datetime.min.time()),
